...
public class List_DAO {
    ...
    public List_DAO(String URL, String USER, String PASSWORD) {
        this.URL = URL;
        this.USER = USER;
    ...
    public List<List_mod> getAllContacts() throws SQLException {
        ...
        while (rs.next()) {
            ...
            List_mod list = new List_mod(id, first_name, last_name, phone_number, mail_user, add_date);
            lists.add(list);
        }
    ...
    public boolean IsAllAccessZero() throws SQLException {
    ...
    public boolean BlockContacts(List_mod block) throws SQLException {
    ...
    public boolean SureDeleteContacts(List_mod del) throws SQLException {
        if (del == null) {
