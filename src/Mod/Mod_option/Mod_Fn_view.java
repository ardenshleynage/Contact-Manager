 ...
 */
public class Mod_Fn_view extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Mod_Fn_view
     */
    public Mod_Fn_view(String firstName, String id) {
        this.currentFirstName = firstName;
        this.contactId = id;
        this.ctrlln = new Mod_ctrl(URL, USER, PASSWORD);
        initComponents();
        jLabel1.setText("Prénom Actuel : " + currentFirstName);
    }
    ...
    private void modifyFirstName() {
        ...
        Mod_mod modfn = new Mod_mod();
        try {
            modfn.setId(Integer.parseInt(contactId));  // Assurez-vous que contactId peut être converti en int
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "ID du contact invalide.", "Erreur", JOptionPane.ERROR_MESSAGE);
            return;
        }
        modfn.setFirst_name(newFirstName);

        try {
            ctrlln.updateFirstNameContact(modfn);
    ...
    private void initComponents() {
        ...
        user_fn_mod.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        user_fn_mod.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btn_fn_mod.setForeground(new java.awt.Color(255, 255, 255));
        btn_fn_mod.setText("Modifier");
        btn_fn_mod.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                btn_fn_mod.setBackground(Color.WHITE);
                btn_fn_mod.setForeground(Color.BLACK);
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btn_fn_mod.setBackground(Color.BLACK);
                btn_fn_mod.setForeground(Color.WHITE);
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mod_Fn_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mod_Fn_view("", "").setVisible(true);
            }
        });
    }
