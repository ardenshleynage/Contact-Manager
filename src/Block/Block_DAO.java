...
public class Block_DAO {
    ...
    public Block_DAO(String URL, String USER, String PASSWORD) {
        this.URL = URL;
        this.USER = USER;
    ...
    public List<Block_mod> getAllContacts() throws SQLException {
        ...
        while (rs.next()) {
            ...
            Block_mod block = new Block_mod(id, first_name, last_name, phone_number, mail_user, add_date);
            blocks.add(block);
        }
    ...
    public boolean blockContacts(Block_mod block) throws SQLException {
    ...
    public boolean blockAllContacts() throws SQLException {
        String sql = "UPDATE contacts SET access = 0";
        connect();
