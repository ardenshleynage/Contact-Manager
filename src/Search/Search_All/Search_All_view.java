 ...
 */
public class Search_All_view extends javax.swing.JFrame {

    private static Search_All_ctrl SearchAllCtrl;
    private static final String HOST = "jdbc:mysql://localhost:3306/contact_manager";
    private static final String USER = "root";
    private static final String PASSWORD = "";
    Search_All_mod del;
    Search_All_mod block;

    /**
     * Creates new form Search_All_view
     */
    public Search_All_view() {
        initComponents();
        SearchAllCtrl = new Search_All_ctrl(HOST, USER, PASSWORD);
    }

    private void SearchAll() {
        String afo = usr_all.getText().trim();

        // Call the controller to perform the search
        List<Search_All_mod> results = SearchAllCtrl.searchByAll(afo);
        if (afo.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Aucun résultat pour la recherche '" + afo + "'", "Résultats de recherche", JOptionPane.INFORMATION_MESSAGE);
        } else {
            // Create table to display results
            String[] columnNames = {"Nom", "Prénom", "Numéro Téléphone", "Adresse Email", "Date d'Ajout", "Id"};
            DefaultTableModel model = new DefaultTableModel(columnNames, 0);

            for (Search_All_mod contact : results) {
                Object[] row = {
            ...
            resultTable.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                public void mouseClicked(java.awt.event.MouseEvent evt) {
                    ...
                    if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(evt)) {
                        ...
                        List<Search_All_mod> contacts = SearchAllCtrl.searchByAll("");
                        if (contacts != null && !contacts.isEmpty()) {
                            // Retrieve the selected contact
                            Search_All_mod selectedContact = contacts.get(selectedRow);
                            ...
                            switch (option) {
                                ...
                                case 1: // "Bloquer"
                                    if (block != null) {
                                        SearchAllCtrl.BlockContacts(block);
                                        JOptionPane.showMessageDialog(Search_All_view.this, "Contact bloqué avec succès", "Bloquer", JOptionPane.INFORMATION_MESSAGE);
                                        App.main(null);
                                    } else {
                                        JOptionPane.showMessageDialog(Search_All_view.this, "Aucun contact sélectionné pour bloquer.", "Erreur", JOptionPane.ERROR_MESSAGE);
                                    }
                                    break;
                                case 2: // "Supprimer"
                                    if (del != null) {
                                        SearchAllCtrl.SureDeleteContacts(del);
                                        DeleteContactsQuestion();
                                    } else {
                                        JOptionPane.showMessageDialog(Search_All_view.this, "Aucun contact sélectionné pour supprimer.", "Erreur", JOptionPane.ERROR_MESSAGE);
                                    }
                                    break;
                                case 3: // "Annuler"
    ...
    private void handleDeleteAllContacts() {
        boolean success = SearchAllCtrl.SureDeleteContacts(del);
    ...
    private void initComponents() {
        ...
        srch_all = new javax.swing.JLabel();
        back_home = new javax.swing.JButton();
        usr_all = new javax.swing.JTextField();
        ExitApp = new javax.swing.JButton();
        srch_all_btn = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setBackground(new java.awt.Color(51, 0, 153));

        Search_all.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        Search_all.setForeground(new java.awt.Color(255, 255, 255));
        Search_all.setText("Tous Rechercher");
        Search_all.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 3, 0, new java.awt.Color(255, 255, 255)));

        srch_all.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        srch_all.setForeground(new java.awt.Color(255, 255, 255));
        srch_all.setText("Entrer votre recherche :");
        ...
        srch_all_btn.setBackground(new java.awt.Color(0, 0, 0));
        srch_all_btn.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        srch_all_btn.setForeground(new java.awt.Color(255, 255, 255));
        srch_all_btn.setText("Rechercher");
        srch_all_btn.setMaximumSize(new java.awt.Dimension(79, 33));
        srch_all_btn.setMinimumSize(new java.awt.Dimension(79, 33));
        srch_all_btn.setPreferredSize(new java.awt.Dimension(79, 33));
        srch_all_btn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                srch_all_btn.setBackground(Color.WHITE);
                srch_all_btn.setForeground(Color.BLACK);
            }

            @Override
            public void mouseExited(MouseEvent e) {
                srch_all_btn.setBackground(Color.BLACK);
                srch_all_btn.setForeground(Color.WHITE);
            }
        });
        srch_all_btn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                srch_all_btnActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(srch_all)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(usr_all)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(srch_all_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(25, 25, 25))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(srch_all)
                    .addComponent(usr_all, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(srch_all_btn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void srch_all_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_srch_all_btnActionPerformed
        // TODO add your handling code here:
        SearchAll();
    }//GEN-LAST:event_srch_all_btnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Search_All_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_All_view().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel srch_all;
    private javax.swing.JButton srch_all_btn;
    private javax.swing.JTextField usr_all;
