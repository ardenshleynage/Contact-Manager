 ...
 */
public class Search_Ln_view extends javax.swing.JFrame {

    private static Search_Ln_ctrl SearchLnCtrl;
    ...
    /**
     * Creates new form Search_Ln_view
     */
    public Search_Ln_view() {
        initComponents();
        SearchLnCtrl = new Search_Ln_ctrl(HOST, USER, PASSWORD);
    }

    private void SearchLn() {
        String lastName = usr_ln.getText().trim();

        // Call the controller to perform the search
        List<Search_Ln_mod> results = SearchLnCtrl.searchByLastName(lastName);
        if (lastName.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Aucun résultat pour le nom '" + lastName + "'", "Résultats de recherche", JOptionPane.INFORMATION_MESSAGE);
        } else {
            // Create table to display results
            String[] columnNames = {"Nom", "Prénom", "Numéro Téléphone", "Adresse Email", "Date d'Ajout", "ID"};
            DefaultTableModel model = new DefaultTableModel(columnNames, 0);

            for (Search_Ln_mod contact : results) {
                Object[] row = {
            ...
            resultTable.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                public void mouseClicked(java.awt.event.MouseEvent evt) {
                    ...
                    if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(evt)) {
                        ...
                        List<Search_Ln_mod> contacts = SearchLnCtrl.searchByLastName(""); // Adjust to pass appropriate search criteria
                        if (contacts != null && !contacts.isEmpty()) {
                            // Retrieve the selected contact
                            Search_Ln_mod selectedContact = contacts.get(selectedRow);
                            ...
                            switch (option) {
                                ...
                                case 1: // "Bloquer"
                                    if (block != null) {
                                        SearchLnCtrl.BlockContacts(block);
                                        JOptionPane.showMessageDialog(Search_Ln_view.this, "Contact bloqué avec succès", "Bloquer", JOptionPane.INFORMATION_MESSAGE);
                                        App.main(null);
                                    } else {
                                        JOptionPane.showMessageDialog(Search_Ln_view.this, "Aucun contact sélectionné pour bloquer.", "Erreur", JOptionPane.ERROR_MESSAGE);
                                    }
                                    break;
                                case 2: // "Supprimer"
                                    if (del != null) {
                                        SearchLnCtrl.SureDeleteContacts(del);
                                        DeleteContactsQuestion();
                                    } else {
                                        JOptionPane.showMessageDialog(Search_Ln_view.this, "Aucun contact sélectionné pour supprimer.", "Erreur", JOptionPane.ERROR_MESSAGE);
                                    }
                                    break;
                                case 3: // "Annuler"
    ...
    private void handleDeleteAllContacts() {
        boolean success = SearchLnCtrl.SureDeleteContacts(del);
    ...
    private void initComponents() {
        ...
        srch_ln = new javax.swing.JLabel();
        search_ln = new javax.swing.JLabel();
        usr_ln = new javax.swing.JTextField();
        search_btn_ln = new javax.swing.JButton();
        ...
        srch_ln.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        srch_ln.setForeground(new java.awt.Color(255, 255, 255));
        srch_ln.setText("Rechercher par nom");
        srch_ln.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 3, 0, new java.awt.Color(255, 255, 255)));

        search_ln.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        search_ln.setForeground(new java.awt.Color(255, 255, 255));
        search_ln.setText("Entrer le nom :");

        search_btn_ln.setBackground(new java.awt.Color(0, 0, 0));
        search_btn_ln.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        search_btn_ln.setForeground(new java.awt.Color(255, 255, 255));
        search_btn_ln.setText("Rechercher");
        search_btn_ln.setMaximumSize(new java.awt.Dimension(78, 33));
        search_btn_ln.setMinimumSize(new java.awt.Dimension(78, 33));
        search_btn_ln.setPreferredSize(new java.awt.Dimension(78, 33));
        search_btn_ln.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                search_btn_ln.setBackground(Color.WHITE);
                search_btn_ln.setForeground(Color.BLACK);
            }

            @Override
            public void mouseExited(MouseEvent e) {
                search_btn_ln.setBackground(Color.BLACK);
                search_btn_ln.setForeground(Color.WHITE);
            }
        });
        search_btn_ln.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                search_btn_lnActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(search_ln)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(usr_ln, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(search_btn_ln, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(41, 41, 41))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(54, 54, 54)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(search_ln, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(search_btn_ln, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void search_btn_lnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_btn_lnActionPerformed
        // TODO add your handling code here:
        SearchLn();
    }//GEN-LAST:event_search_btn_lnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Search_Ln_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_Ln_view().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton search_btn_ln;
    private javax.swing.JLabel search_ln;
    private javax.swing.JLabel srch_ln;
