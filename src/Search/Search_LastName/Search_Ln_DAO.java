...
public class Search_Ln_DAO {
    ...
    public Search_Ln_DAO(String URL, String USER, String PASSWORD) {
        this.URL = URL;
        this.USER = USER;
    ...
    public List<Search_Ln_mod> searchByLastName(String last_name) throws SQLException {
        List<Search_Ln_mod> adds = new ArrayList<>();
        String sql = "SELECT * FROM contacts WHERE last_name LIKE ? AND access = 1";
        connect();
        ...
        try (PreparedStatement statement = con.prepareStatement(sql)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    Search_Ln_mod add = new Search_Ln_mod(id, l_name, first_name, phone_number, mail_user, add_date);
                    adds.add(add);
                }
            }
    ...
    public boolean SureDeleteContacts(Search_Ln_mod del) throws SQLException {
        if (del == null) {
    ...
    public boolean BlockContacts(Search_Ln_mod block) throws SQLException {
