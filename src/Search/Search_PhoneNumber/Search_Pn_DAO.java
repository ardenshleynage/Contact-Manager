...
public class Search_Pn_DAO {
    ...
    public Search_Pn_DAO(String URL, String USER, String PASSWORD) {
        this.URL = URL;
        this.USER = USER;
    ...
    public List<Search_Pn_mod> searchByPhoneNumber(String phone_number) throws SQLException {
        List<Search_Pn_mod> adds = new ArrayList<>();
        String sql = "SELECT * FROM contacts WHERE phone_number LIKE ? AND access = 1";
        connect();
        ...
        try (PreparedStatement statement = con.prepareStatement(sql)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    Search_Pn_mod add = new Search_Pn_mod(id, l_name, first_name, p_number, mail_user, add_date);
                    adds.add(add);
                }
            }
    ...
    public boolean SureDeleteContacts(Search_Pn_mod del) throws SQLException {
        if (del == null) {
    ...
    public boolean BlockContacts(Search_Pn_mod block) throws SQLException {
